...
export default class CreateLeague extends Component {
  ...
  render() {
    return <>
      ...
      <ul name='leaguesList'>{this.state.leagues.map(element => <li> {element.leagueName}
      ...
      <form className='createLeague' name='createLeague' onSubmit={this.onSubmit}>
        ...
        <input className='createLeague__input' name='startDate' type="date" required />
        <br />
        <label className='createLeague__label'>End date: </label>
        <input className='createLeague__input' name='endDate' type="date" required />
